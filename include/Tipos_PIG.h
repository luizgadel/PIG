...
vers�o da PIG compat�vel: 0.5.1
********************************/
...
EVENTO_AUDIO: (n�o implementado)
EVENTO_CONTROLADOR: (n�o implementado)
EVENTO_USUARIO: (n�o implementado)
********************************/
typedef enum PIG_TipoEvento
{
    EVENTO_NULO,
    EVENTO_GERAL,
    EVENTO_JANELA,
...
posX: a posi��o no eixo X do ponteiro do mouse no momento de ocorr�ncia do evento
posY: a posi��o no eixo Y do ponteiro do mouse no momento de ocorr�ncia do evento
botao: indica qual dos tr�s bot�es foi pressionado ou liberado
